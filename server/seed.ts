...
async function seedDatabase() {
  ...
  const sampleTrainings = [
    ...
    },
    {
      ...
      description: "Earthquake preparedness, safety protocols, and post-disaster assessment techniques",
      district: "Koraput",
      location: "Civil Defence Office, Koraput",
      startAt: new Date("2025-05-05T09:00:00"),
      endAt: new Date("2025-05-05T17:00:00"),
      capacity: 35,
      skills: ["Earthquake Safety", "Structural Assessment", "Emergency Response"],
      status: "upcoming" as const,
      isStatewide: false,
      createdBy: districtAdminUser?.id || "",
    },
    {
      ...
      description: "Training on providing mental health support and psychological first aid during disasters",
      district: "Khordha",
      location: "Mental Health Training Center, Bhubaneswar",
      startAt: new Date("2025-05-12T09:00:00"),
      endAt: new Date("2025-05-13T17:00:00"),
      capacity: 40,
      skills: ["Mental Health Support", "Trauma Care", "Crisis Counseling"],
      status: "upcoming" as const,
      isStatewide: true,
      createdBy: departmentAdminUser?.id || "",
    },
    {
      title: "Night Operations and Low Visibility Rescue",
      description: "Specialized training for conducting rescue operations in low visibility and night conditions",
      district: "Angul",
      location: "Special Training Facility, Angul",
      startAt: new Date("2025-05-20T18:00:00"),
      endAt: new Date("2025-05-21T06:00:00"),
      capacity: 25,
      skills: ["Night Operations", "Low Visibility Navigation", "Tactical Response"],
      status: "upcoming" as const,
      isStatewide: false,
      createdBy: districtAdminUser?.id || "",
    },
    {
      ...
      description: "Training on identifying and safely handling hazardous materials during emergencies",
      district: "Jharsuguda",
      location: "Industrial Safety Training Center, Jharsuguda",
      startAt: new Date("2025-06-01T09:00:00"),
      endAt: new Date("2025-06-02T17:00:00"),
      capacity: 30,
      skills: ["Hazmat Response", "Chemical Safety", "Decontamination"],
      status: "upcoming" as const,
      isStatewide: false,
      createdBy: districtAdminUser?.id || "",
    },
    {
      title: "Drone Operations for Disaster Assessment",
      description: "Statewide training on using drones for aerial disaster assessment and search operations",
      district: "Khordha",
      location: "Technology Training Campus, Bhubaneswar",
      startAt: new Date("2025-06-10T09:00:00"),
      endAt: new Date("2025-06-12T17:00:00"),
      capacity: 20,
      skills: ["Drone Operation", "Aerial Survey", "Technology Use"],
      status: "upcoming" as const,
      isStatewide: true,
      createdBy: departmentAdminUser?.id || "",
    },
    {
      title: "Community Shelter Management",
      description: "Training on setting up and managing emergency shelters for displaced populations",
      district: "Gajapati",
      location: "Relief Camp Training Center, Parlakhemundi",
      startAt: new Date("2025-06-18T09:00:00"),
      endAt: new Date("2025-06-19T17:00:00"),
      capacity: 45,
      skills: ["Shelter Management", "Relief Distribution", "Logistics"],
      status: "upcoming" as const,
      isStatewide: false,
      createdBy: districtAdminUser?.id || "",
    },
    {
      title: "Water Purification and Sanitation",
      description: "Emergency water purification techniques and sanitation management in disaster zones",
      district: "Kalahandi",
      location: "Public Health Training Center, Bhawanipatna",
      startAt: new Date("2025-07-01T09:00:00"),
      endAt: new Date("2025-07-01T17:00:00"),
      capacity: 35,
      skills: ["Water Purification", "Sanitation", "Public Health"],
      status: "upcoming" as const,
      isStatewide: false,
      createdBy: districtAdminUser?.id || "",
    },
    {
      title: "Swift Water Rescue Certification",
      description: "Advanced swift water rescue techniques and certification program",
      district: "Sundargarh",
      location: "River Training Facility, Rourkela",
      startAt: new Date("2025-07-15T08:00:00"),
      endAt: new Date("2025-07-17T18:00:00"),
      capacity: 20,
      skills: ["Swift Water Rescue", "River Safety", "Advanced Swimming"],
      status: "upcoming" as const,
      isStatewide: false,
      createdBy: districtAdminUser?.id || "",
    },
    {
      title: "Mass Feeding and Nutrition Management",
      description: "Training on large-scale food preparation and nutrition management in relief camps",
      district: "Bargarh",
      location: "Relief Operations Training Center, Bargarh",
      startAt: new Date("2025-07-25T09:00:00"),
      endAt: new Date("2025-07-25T17:00:00"),
      capacity: 40,
      skills: ["Mass Cooking", "Nutrition Management", "Food Safety"],
      status: "upcoming" as const,
      isStatewide: false,
      createdBy: districtAdminUser?.id || "",
    },
    {
      title: "Incident Command System (ICS) Training",
      description: "Statewide certification training on Incident Command System for disaster coordination",
      district: "Khordha",
      location: "State Emergency Training Academy, Bhubaneswar",
      startAt: new Date("2025-08-01T09:00:00"),
      endAt: new Date("2025-08-05T17:00:00"),
      capacity: 50,
      skills: ["Incident Command", "Disaster Coordination", "Leadership"],
      status: "upcoming" as const,
      isStatewide: true,
      createdBy: departmentAdminUser?.id || "",
    },
